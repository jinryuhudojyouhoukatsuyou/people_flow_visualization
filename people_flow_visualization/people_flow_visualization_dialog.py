...
class PeopleFlowVisualizationDialog(QtWidgets.QDialog, FORM_CLASS):
    ...
    def do_crosstab_time(self) :
        ...
        for i in range(diff, 390+diff, diff):
        ...
        for data in tab.itertuples():
            ...
            for i in range(7):
                ...
                if cnt == 0 :
                    html_cross2 += '<th>' + str(value) + '</th>'
                else :
                    html_cross2 += '<td>' + '{:.2f}'.format(value * 100) + '%</td>'
                cnt = cnt + 1
            html_cross2 += '</tr>'
